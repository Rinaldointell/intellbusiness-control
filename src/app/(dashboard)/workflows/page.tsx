...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona 5-7 noticias más relevantes para el nicho de Rinaldo",
  ...
  },
  {
    ...
    steps: [
      ...
      "Evalúa si el trend es relevante para el canal de Rinaldo",
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona tema con mayor potencial de engagement para la audiencia de Rinaldo",
      "Redacta post de LinkedIn en la voz de Rinaldo (profesional-cercano, sin emojis ni hashtags)",
  ...
  },
  {
    ...
    description: "Digest curado de las newsletters del día. Consolida lo mejor de las suscripciones de Rinaldo en un resumen accionable.",
  ...
  },
  {
    ...
    description: "Categoriza y resume los emails del día para que Rinaldo empiece la jornada sin inbox anxiety.",
    schedule: "7:45h (cada día)",
    trigger: "cron",
    status: "active",
    steps: [
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Rinaldo envía /cfo, /cmo, /cto, /legal, /growth, /coach o /producto",
      "Tenacitas carga el skill advisory-board/SKILL.md",
      "Lee el archivo de memoria del advisor correspondiente (memory/advisors/)",
      "Responde en la voz y personalidad del advisor con contexto de Rinaldo",
  ...
  },
  {
    ...
    steps: [
      ...
      "Notifica a Rinaldo por Telegram con el resumen de lo implementado",
    ],
  },
];
